...
################################
# script to download CHIRPS v2.0 prelim p05 global data
#
# P.Wolski
# June 2023
#
...
#rootdir derined in csisEnv
outdir=$rootdir/incoming/CHIRPS-v2.0-p05-prelim/global/day
...
if [ $# -ge 1 ]; then
    ...
    #update latency of chirps prelim is 5 days
...
while [ "$cdate" != $enddate ]; do
    ...
    remotedir=https://data.chc.ucsb.edu/products/CHIRPS-2.0/prelim/global_daily/tifs/p05/$year/
    remotefile=$outfile
